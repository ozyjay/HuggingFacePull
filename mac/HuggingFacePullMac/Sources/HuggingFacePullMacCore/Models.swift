...
public struct InstalledDeleteResponse: Decodable, Equatable, Sendable {
    public let ok: Bool
    public let freedSize: Int64

    enum CodingKeys: String, CodingKey {
        case ok
        case freedSize = "freed_size"
    }
}
